<?php
    ...
    class Pinterest_API {
        ...
        function fetch_access_token($client_id, $client_secret, $username, $password) {
            ...
            $endpoint = "/v3/oauth/access_token?client_id=$client_id&client_secret=$client_secret";
		...
		function allByUser($userName, $params=array()) {
		    $params = self::params_filter($params, array(
                'limit' => 36,
                'page' => 1
            )); 
            
            return $this->get('/pidgets/users/' . $userName . '/pins/', $params);
		}
